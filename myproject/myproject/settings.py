...
SECRET_KEY = 'django-insecure-o6jj-qsk^rr&s(-d&@egz=(c2%g&*2$9qr2lce0c@xg5g=-*^0'
...
OAUTH2_PROVIDER = {
    ...
    'ACCESS_TOKEN_EXPIRE_SECONDS': 3600,  # Access token expiration time in seconds
...
LOGGING = {
    ...
    'loggers': {
        ...
        'myapp': {  # Replace 'myapp' with the name of your Django app
            'handlers': ['console'],
            'level': 'DEBUG',  # Adjust the log level as needed
            'propagate': False,  # Set to False to prevent double-logging if using other loggers
        },
    },
}
